defmodule FoPost do
  ...
  `FoPost.Media`, `FoPost.Inbox`, `FoPost.Contacts`, `FoPost.Broadcasts`, `FoPost.Sequences`,
  `FoPost.Ads`, `FoPost.Validate`. Anything they do not wrap is reachable through `request/4`.
  """
